        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">{{ __('Portfolios') }}</h3>
                ...
                <div class="card-body">
                    ...
                    @if (isset($portfolio))
                        <form action="{{ route('admin.portfolios.update', $portfolio->id) }}" method="post" id="postForm"
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="link" class="form-control"
                                                ...
                                                value="{{ $portfolio->video }}" id="link" onkeyup="youtube_parser(this.value);"/>

                                            <input type="hidden" name="video" class="form-control"
                                                placeholder="{{ __('Video') }}" autocomplete="off"
                                                value="{{ $portfolio->video }}" id="video_link" />
                                        </div>
                                    </div>
                                    <!-- /.form-group -->
                                </div>
                                        ...
                                        <div class="card-body box-profile">
                                            <div class="text-center">
                                                <img class="profile-user-img img-fluid img-circle"
                                                    src="{{ asset($portfolio->photo) }}" alt="User profile picture"
                                                    id="galleryPhoto">
                                            </div>
                                            <br>
                    ...
                    @else
                        <form action="{{ route('admin.portfolios.store') }}" method="post" id="postForm"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-9">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm bg-teal"
                                                    href="{{ route('admin.portfolios.edit', [$item->id]) }}"><span
