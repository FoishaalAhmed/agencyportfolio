        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.walls.update', $wall->id) }}" method="post" id="userForm"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" style="width: 100%;" name="service_id"
                                                ...
                                                @foreach ($services as $item)
                                                    <option value="{{ $item->id }}" @if ($wall->service_id == $item->id) {{ 'selected' }} @endif>
                                                        {{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <select name="year" id="year" class="form-control select2"
                                                    ...
                                                    @for ($i = $year; $i >= 1971; $i--)
                                                        <option value="{{ $i }}" @if ($wall->year == $i) {{ 'selected' }} @endif>
                                                            {{ $i }}</option>
                                                    @endfor
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control" placeholder="{{ __('Description') }}"
                                                    autocomplete="off"
                                                    name="description"> {{ $wall->description }} </textarea>
                                            </div>
                                        </div>
                                        <!-- /.form-group -->
                                    </div>
                                    ...
                                    <div class="card-body box-profile">
                                        <div class="text-center">
                                            <img class="profile-user-img img-fluid img-circle"
                                                src="{{ asset($wall->photo) }}" alt="User profile picture"
                                                id="userPhoto">
