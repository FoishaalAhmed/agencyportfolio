...
<head>
    ...
    <title>Prionty | @yield('title')</title>
...
<body class="hold-transition sidebar-mini dark-mode @if(request()->is('admin/Prionty')
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ URL::to('/') }}" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Prionty</span>
            </a>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ date('Y') }} <a href="{{ URL::to('/') }}">prionty.com</a>.</strong>
            All rights reserved.
